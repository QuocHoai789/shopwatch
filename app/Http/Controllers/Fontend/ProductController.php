...
class ProductController extends Controller
{
    public function all_male_product(Request $request){
    	$product = Products::join('brands','products.brands_id','=','brands.id')->join('image_product','products.id','=','image_product.products_id')->join('info_product','products.id','=','info_product.products_id')->where('image_product.level',1)->whereIn('info_product.gender',[1,10])->select('products.*','image_product.image');
    	$tempt = 0;
    	if($request->has('sort')){
    	 	$tempt = 1;
    	 	$sort = $request->sort;
    ...
    public function all_male_product_brand(Request $request, $id){
    	...
    	$product = Products::join('brands','products.brands_id','=','brands.id')->join('image_product','products.id','=','image_product.products_id')->join('info_product','products.id','=','info_product.products_id')->where('image_product.level',1)->where('products.brands_id',$id)->whereIn('info_product.gender',[1,10])->select('products.*','image_product.image');
    	$tempt = 0;
    	if($request->has('sort')){
    	 	$tempt = 1;
    	 	$sort = $request->sort;
    ...
    public function all_female_product(Request $request){
        $product=Products::join('brands','products.brands_id','=','brands.id')->join('image_product','products.id','=','image_product.products_id')->join('info_product','products.id','=','info_product.products_id')->where('image_product.level',1)->whereIn('info_product.gender',[0,10])->select('products.*','image_product.image');
        $tempt = 0;
        if($request->has('sort')){
            $tempt = 1;
            $sort = $request->sort;
    ...
    public function all_female_product_brand(Request $request,$id){
        ...
        if($request->has('price')){
            ...
            switch ($price) {
                case '1':
                    $produc = $product->where('products.sellprice','<',5000000);
                    break;
                case '2':
                    $product = $product->whereBetween('products.sellprice',[5000000,10000000]);
                    break;
